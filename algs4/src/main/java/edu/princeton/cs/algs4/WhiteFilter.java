/**
 * **************************************************************************** Compilation: javac
 * WhiteFilter.java Execution: java WhiteFilter whitelist.txt < input.txt Dependencies: SET In.java
 * StdIn.java StdOut.java Data files: https://algs4.cs.princeton.edu/35applications/tinyTale.txt
 * https://algs4.cs.princeton.edu/35applications/list.txt
 *
 * <p>Read in a whitelist of words from a file. Then read in a list of words from standard input and
 * print out all those words that are in the first file.
 *
 * <p>% more tinyTale.txt it was the best of times it was the worst of times it was the age of
 ...
 * winter of despair
 *
 * <p>% more list.txt was it the of
 *
 * <p>% java WhiteFilter list.txt < tinyTale.txt it was the of it was the of it was the of it was
 * the of it was the of it was the of it was the of it was the of it was the of it was the of
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code WhiteFilter} class provides a client for reading in a <em>whitelist</em> of words from
 * a file; then, reading in a sequence of words from standard input, printing out each word that
 * appears in the file. It is useful as a test client for various symbol table implementations.
 *
