/**
 * **************************************************************************** Compilation: javac
 * RunLength.java Execution: java RunLength - < input.txt (compress) Execution: java RunLength + <
 ...
 *
 * <p>Compress or expand binary input from standard input using run-length encoding.
 *
 * <p>% java BinaryDump 40 < 4runs.bin 0000000000000001111111000000011111111111 40 bits
 *
 * <p>This has runs of 15 0s, 7 1s, 7 0s, and 11 1s.
 *
 * <p>% java RunLength - < 4runs.bin | java HexDump 0f 07 07 0b 4 bytes
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code RunLength} class provides static methods for compressing and expanding a binary input
 * using run-length coding with 8-bit run lengths.
 *
...
public class RunLength {
  ...
  /**
   * Reads a sequence of bits from standard input (that are encoded using run-length encoding with
   * 8-bit run lengths); decodes them; and writes the results to standard output.
   */
  ...
  /**
   * Reads a sequence of bits from standard input; compresses them using run-length coding with
   * 8-bit run lengths; and writes the results to standard output.
   */
