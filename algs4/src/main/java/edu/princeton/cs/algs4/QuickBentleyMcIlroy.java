/**
 * **************************************************************************** Compilation: javac
 * QuickBentleyMcIlroy.java Execution: java QuickBentleyMcIlroy < input.txt Dependencies:
 * StdOut.java StdIn.java Data files: https://algs4.cs.princeton.edu/23quicksort/tiny.txt
 * https://algs4.cs.princeton.edu/23quicksort/words3.txt
 *
 * <p>Uses the Bentley-McIlroy 3-way partitioning scheme, chooses the partitioning element using
 * Tukey's ninther, and cuts off to insertion sort.
 *
 * <p>Reference: Engineering a Sort Function by Jon L. Bentley and M. Douglas McIlroy.
 * Softwae-Practice and Experience, Vol. 23 (11), 1249-1265 (November 1993).
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code QuickBentleyMcIlroy} class provides static methods for sorting an array using an
 * optimized version of quicksort (using Bentley-McIlroy 3-way partitioning, Tukey's ninther, and
