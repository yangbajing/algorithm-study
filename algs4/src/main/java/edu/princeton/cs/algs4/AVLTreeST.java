/**
 * **************************************************************************** Compilation: javac
 * AVLTreeST.java Execution: java AVLTreeST < input.txt Dependencies: StdIn.java StdOut.java Data
 * files: https://algs4.cs.princeton.edu/33balanced/tinyST.txt
 *
 * <p>A symbol table implemented using an AVL tree.
 *
 * <p>% more tinyST.txt S E A R C H E X A M P L E
 *
 * <p>% java AVLTreeST < tinyST.txt A 8 C 4 E 12 H 5 L 11 M 9 P 10 R 3 S 0 X 7
 *
 * <p>****************************************************************************
 */
 ...
 * equals()} or {@code hashCode()}. The <em>put</em>, <em>get</em>, <em>contains</em>,
...
public class AVLTreeST<Key extends Comparable<Key>, Value> {
  ...
  /**
   * Returns value associated with the given key in the subtree or {@code null} if no such key.
   *
   * @param x the subtree
   * @param key the key
   * @return value associated with the given key in the subtree or {@code null} if no such key
   */
  ...
  /**
   * Inserts the key-value pair in the subtree. It overrides the old value with the new value if the
   * symbol table already contains the specified key and deletes the specified key (and its
  ...
  /**
   * Adds the keys between {@code lo} and {@code hi} in the subtree to the {@code queue}.
   *
   * @param x the subtree
   * @param queue the queue
   * @param lo the lowest key
  ...
  /**
   * Checks if the tree rooted at x is a BST with all keys strictly between min and max (if min or
