/**
 * **************************************************************************** Compilation: javac
 * QuickX.java Execution: java QuickX < input.txt Dependencies: StdOut.java StdIn.java Data files:
 * https://algs4.cs.princeton.edu/23quicksort/tiny.txt
 * https://algs4.cs.princeton.edu/23quicksort/words3.txt
 *
 * <p>Uses the Hoare's 2-way partitioning scheme, chooses the partitioning element using
 * median-of-3, and cuts off to insertion sort.
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code QuickX} class provides static methods for sorting an array using an optimized version
 * of quicksort (using Hoare's 2-way partitioning algorithm, median-of-3 to choose the partitioning
 * element, and cutoff to insertion sort).
 *
...
public class QuickX {
   ...
   * of 2-way quicksort); and prints them to standard output in ascending order.
   *
