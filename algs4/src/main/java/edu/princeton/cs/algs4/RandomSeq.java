/**
 * **************************************************************************** Compilation: javac
 * RandomSeq.java Execution: java RandomSeq n lo hi Dependencies: StdOut.java
 *
 * <p>Prints N numbers between lo and hi.
 *
 * <p>% java RandomSeq 5 100.0 200.0 123.43 153.13 144.38 155.18 104.02
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code RandomSeq} class is a client that prints out a pseudorandom sequence of real numbers
 * in a given range.
 *
...
public class RandomSeq {
  ...
  /**
   * Reads in two command-line arguments lo and hi and prints n uniformly random real numbers in
   * [lo, hi) to standard output.
   *
