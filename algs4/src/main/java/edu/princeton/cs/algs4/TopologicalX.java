/**
 * **************************************************************************** Compilation: javac
 * TopologicalX.java Execution: java TopologicalX V E F Dependencies: Queue.java Digraph.java
 *
 * <p>Compute topological ordering of a DAG using queue-based algorithm. Runs in O(E + V) time.
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code TopologicalX} class represents a data type for determining a topological order of a
 ...
 *
 * <p>This implementation uses a nonrecursive, queue-based algorithm. The constructor takes
 ...
 * uses &Theta;(<em>V</em>) extra space (not including the digraph).
 *
 * <p>See {@link DirectedCycle}, {@link DirectedCycleX}, and {@link EdgeWeightedDirectedCycle} to
 * compute a directed cycle if the digraph is not a DAG. See {@link Topological} for a recursive
 * version that uses depth-first search.
 *
...
public class TopologicalX {
  ...
  public static void main(String[] args) {
    ...
    for (int v = 0; v < G1.V(); v++)
      for (int w : G1.adj(v)) G2.addEdge(new DirectedEdge(v, w, 0.0));
