/**
 * **************************************************************************** Compilation: javac
 * BoyerMoore.java Execution: java BoyerMoore pattern text Dependencies: StdOut.java
 *
 * <p>Reads in two strings, the pattern and the input text, and searches for the pattern in the
 * input text using the bad-character rule part of the Boyer-Moore algorithm. (does not implement
 * the strong good suffix rule)
 *
 * <p>% java BoyerMoore abracadabra abacadabrabracabracadabrabrabracad text:
 * abacadabrabracabracadabrabrabracad pattern: abracadabra
 *
 * <p>% java BoyerMoore rab abacadabrabracabracadabrabrabracad text:
 * abacadabrabracabracadabrabrabracad pattern: rab
 *
 * <p>% java BoyerMoore bcara abacadabrabracabracadabrabrabracad text:
 * abacadabrabracabracadabrabrabracad pattern: bcara
 *
 * <p>% java BoyerMoore rabrabracad abacadabrabracabracadabrabrabracad text:
 * abacadabrabracabracadabrabrabracad pattern: rabrabracad
 *
 * <p>% java BoyerMoore abacad abacadabrabracabracadabrabrabracad text:
 ...
 *
 * <p>This implementation uses the Boyer-Moore algorithm (with the bad-character rule, but not the
