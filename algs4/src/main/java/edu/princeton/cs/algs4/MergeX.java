 ...
 * of mergesort.
 *
 * <p>In the worst case, this implementation takes &Theta;(<em>n</em> log <em>n</em>) time to sort
 * an array of length <em>n</em> (assuming comparisons take constant time).
 *
