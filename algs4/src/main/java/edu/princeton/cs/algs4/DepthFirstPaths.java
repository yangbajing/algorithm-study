/**
 * **************************************************************************** Compilation: javac
 * DepthFirstPaths.java Execution: java DepthFirstPaths G s Dependencies: Graph.java Stack.java
 * StdOut.java Data files: https://algs4.cs.princeton.edu/41graph/tinyCG.txt
 * https://algs4.cs.princeton.edu/41graph/tinyG.txt
 * https://algs4.cs.princeton.edu/41graph/mediumG.txt
 * https://algs4.cs.princeton.edu/41graph/largeG.txt
 *
 * <p>Run depth-first search on an undirected graph.
 *
 * <p>% java Graph tinyCG.txt 6 8 0: 2 1 5 1: 0 2 2: 0 1 3 4 3: 5 4 2 4: 3 2 5: 3 0
 *
 * <p>% java DepthFirstPaths tinyCG.txt 0 0 to 0: 0 0 to 1: 0-2-1 0 to 2: 0-2 0 to 3: 0-2-3 0 to 4:
 * 0-2-3-4 0 to 5: 0-2-3-5
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code DepthFirstPaths} class represents a data type for finding paths from a source vertex
 * <em>s</em> to every other vertex in an undirected graph.
 *
...
public class DepthFirstPaths {
  ...
  /**
   * Returns a path between the source vertex {@code s} and vertex {@code v}, or {@code null} if no
   * such path.
   *
   * @param v the vertex
   * @return the sequence of vertices on a path between the source vertex {@code s} and vertex
