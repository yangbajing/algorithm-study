 ...
 * the number of edges. (The depth-first search part takes only <em>O</em>(<em>V</em>) time;
 * however, checking for self-loops and parallel edges takes &Theta;(<em>V</em> + <em>E</em>) time
 * in the worst case.) Each instance method takes &Theta;(1) time. It uses &Theta;(<em>V</em>) extra
