 ...
 *
 * <p>In the worst case, this implementation makes ~ <em>n</em> log<sub>2</sub><em>n</em> compares
 * to sort an array of length <em>n</em>. However, in the worst case, the running time is
 * &Theta;(<em>n</em><sup>2</sup>) because the number of array accesses can be quadratic. As such,
 * it is not suitable for sorting large arrays (unless the number of inversions is small).
 *
