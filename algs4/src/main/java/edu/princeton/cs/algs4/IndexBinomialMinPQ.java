/**
 * **************************************************************************** Compilation: javac
 * IndexBinomialMinPQ.java Execution:
 *
 * <p>An index binomial heap.
 *
 * <p>****************************************************************************
 */
...
/**
 * The IndexBinomialMinPQ class represents an indexed priority queue of generic keys. It supports
 ...
 *
 * <p>This implementation uses a binomial heap along with an array to associate keys with integers
 * in the given range. The insert, delete-the-minimum, delete, change-key, decrease-key,
 * increase-key and size operations take logarithmic time. The is-empty, min-index, min-key, and
 * key-of operations take constant time. Construction takes time proportional to the specified
 * capacity.
 *
...
public class IndexBinomialMinPQ<Key> implements Iterable<Integer> {
   ...
   * O(log(n)) hasNext() : Worst case is O(1)
   *
