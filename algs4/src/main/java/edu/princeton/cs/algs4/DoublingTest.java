/**
 * **************************************************************************** Compilation: javac
 * DoublingTest.java Execution: java DoublingTest Dependencies: ThreeSum.java Stopwatch.java
 * StdRandom.java StdOut.java
 *
 * <p>% java DoublingTest 250 0.0 500 0.0 1000 0.1 2000 0.6 4000 4.5 8000 35.7 ...
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code DoublingTest} class provides a client for measuring the running time of a method using
 * a doubling test.
 *
