/**
 * **************************************************************************** Compilation: javac
 * TST.java Execution: java TST < words.txt Dependencies: StdIn.java Data files:
 * https://algs4.cs.princeton.edu/52trie/shellsST.txt
 *
 * <p>Symbol table with string keys, implemented using a ternary search trie (TST).
 *
 * <p>% java TST < shellsST.txt keys(""): by 4 sea 6 sells 1 she 0 shells 3 shore 7 the 5
 *
 * <p>longestPrefixOf("shellsort"): shells
 *
 * <p>keysWithPrefix("shor"): shore
 *
 * <p>keysThatMatch(".he.l."): shells
 *
 * <p>% java TST theory the now is the time for all good men
 *
 * <p>Remarks -------- - can't use a key that is the empty string ""
 *
 * <p>****************************************************************************
 */
 ...
 * values. It supports the usual <em>put</em>, <em>get</em>, <em>contains</em>, <em>delete</em>,
 * <em>size</em>, and <em>is-empty</em> methods. It also provides character-based methods for
 * finding the string in the symbol table that is the <em>longest prefix</em> of a given prefix,
 * finding all strings in the symbol table that <em>start with</em> a given prefix, and finding all
 * strings in the symbol table that <em>match</em> a given pattern. A symbol table implements the
...
public class TST<Value> {
  ...
  private void collect(
      Node<Value> x, StringBuilder prefix, int i, String pattern, Queue<String> queue) {
    if (x == null) return;
