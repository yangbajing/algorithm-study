/**
 * **************************************************************************** Compilation: javac
 * BinaryIn.java Execution: java BinaryIn input output Dependencies: none
 *
 * <p>This library is for reading binary data from an input stream.
 *
 * <p>% java BinaryIn https://introcs.cs.princeton.edu/java/cover.png output.png
 *
 * <p>****************************************************************************
 */
...
/**
 * <i>Binary input</i>. This class provides methods for reading in bits from a binary input stream,
 ...
 *
 * <p>The binary input stream can be from standard input, a filename, a URL name, a Socket, or an
 * InputStream.
 *
 ...
 *
 * <p>The client should not intermix calls to {@code BinaryIn} with calls to {@code In}; otherwise
...
public final class BinaryIn {
   ...
   *
   * @return {@code true} if this binary input stream exists; {@code false} otherwise
   */
   ...
   *
   * @return {@code true} if this binary input stream is empty; {@code false} otherwise
   */
  ...
  /**
   * Unit tests the {@code BinaryIn} data type. Reads the name of a file or URL (first command-line
