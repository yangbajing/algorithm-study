/**
 * **************************************************************************** Compilation: javac
 * Bipartite.java Execution: java Bipartite V E F Dependencies: Graph.java Data files:
...
/**
 * The {@code Bipartite} class represents a data type for determining whether an undirected graph is
 * <em>bipartite</em> or whether it has an <em>odd-length cycle</em>. A graph is bipartite if and
 ...
 *
 * <p>This implementation uses <em>depth-first search</em>. The constructor takes &Theta;(<em>V</em>
 * + <em>E</em>) time in the worst case, where <em>V</em> is the number of vertices and <em>E</em>
 * is the number of edges. Each instance method takes &Theta;(1) time. It uses &Theta;(<em>V</em>)
 * extra space (not including the graph). See {@link BipartiteX} for a nonrecursive version that
