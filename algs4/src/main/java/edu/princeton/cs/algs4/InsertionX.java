/**
 * **************************************************************************** Compilation: javac
 * InsertionX.java Execution: java InsertionX < input.txt Dependencies: StdOut.java StdIn.java Data
 * files: https://algs4.cs.princeton.edu/21elementary/tiny.txt
 * https://algs4.cs.princeton.edu/21elementary/words3.txt
 *
 * <p>Sorts a sequence of strings from standard input using an optimized version of insertion sort
 * that uses half exchanges instead of full exchanges to reduce data movement..
 *
 * <p>% more tiny.txt S O R T E X A M P L E
 *
 * <p>% java InsertionX < tiny.txt A E E L M O P R S T X [ one string per line ]
 *
 * <p>% more words3.txt bed bug dad yes zoo ... all bad yet
 *
 * <p>% java InsertionX < words3.txt all bad bed bug dad ... yes yet zoo [ one string per line ]
 *
 * <p>****************************************************************************
 */
package edu.princeton.cs.algs4;
/**
 * The {@code InsertionX} class provides static methods for sorting an array using an optimized
 * version of insertion sort (with half exchanges and a sentinel).
 *
 * <p>In the worst case, this implementation makes ~ 1/2 <em>n</em><sup>2</sup> compares to sort an
 * array of length <em>n</em>. So, it is not suitable for sorting large arrays (unless the number of
 * inversions is small).
 *
 * <p>This sorting algorithm is stable. It uses &Theta;(1) extra memory (not including the input
 * array).
 *
