/**
 * **************************************************************************** Compilation: javac
 * Complex.java Execution: java Complex Dependencies: StdOut.java
 *
 * <p>Data type for complex numbers.
 *
 * <p>The data type is "immutable" so once you create and initialize a Complex object, you cannot
 * change it. The "final" keyword when declaring re and im enforces this rule, making it a
 * compile-time error to change the .re or .im fields after they've been initialized.
 *
 * <p>% java Complex a = 5.0 + 6.0i b = -3.0 + 4.0i Re(a) = 5.0 Im(a) = 6.0 b + a = 2.0 + 10.0i a -
 * b = 8.0 + 2.0i a * b = -39.0 + 2.0i b * a = -39.0 + 2.0i a / b = 0.36 - 1.52i (a / b) * b = 5.0 +
 * 6.0i conj(a) = 5.0 - 6.0i |a| = 7.810249675906654 tan(a) = -6.685231390246571E-6 +
 * 1.0000103108981198i
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code Complex} class represents a complex number. Complex numbers are immutable: their
 * values cannot be changed after they are created. It includes methods for addition, subtraction,
 * multiplication, division, conjugation, and other common functions on complex numbers.
 *
...
public class Complex {
   ...
   *
   * @return a string representation of this complex number, of the form 34 - 56i.
   */
  ...
  /**
   * Returns the absolute value of this complex number. This quantity is also known as the
   * <em>modulus</em> or <em>magnitude</em>.
   *
  ...
  /**
   * Returns the phase of this complex number. This quantity is also known as the <em>angle</em> or
   * <em>argument</em>.
   *
