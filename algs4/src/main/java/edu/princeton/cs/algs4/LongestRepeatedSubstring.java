/**
 * **************************************************************************** Compilation: javac
 * LongestRepeatedSubstring.java Execution: java LongestRepeatedSubstring < file.txt Dependencies:
 * StdIn.java SuffixArray.java Data files: https://algs4.cs.princeton.edu/63suffix/tale.txt
 * https://algs4.cs.princeton.edu/63suffix/tinyTale.txt
 * https://algs4.cs.princeton.edu/63suffix/mobydick.txt
 *
 * <p>Reads a text string from stdin, replaces all consecutive blocks of whitespace with a single
 * space, and then computes the longest repeated substring in that text using a suffix array.
 *
 * <p>% java LongestRepeatedSubstring < tinyTale.txt 'st of times it was the '
 *
 * <p>% java LongestRepeatedSubstring < mobydick.txt ',- Such a funny, sporty, gamy, jesty, joky,
 * hoky-poky lad, is the Ocean, oh! Th'
 *
 * <p>% java LongestRepeatedSubstring aaaaaaaaa 'aaaaaaaa'
 *
 * <p>% java LongestRepeatedSubstring abcdefg ''
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code LongestRepeatedSubstring} class provides a {@link SuffixArray} client for computing
 ...
 *
 * <p>See also {@link LongestCommonSubstring}.
 *
...
public class LongestRepeatedSubstring {
   ...
   * @return the longest repeated substring that appears in {@code text}; the empty string if no
   *     such string
   */
