/**
 * **************************************************************************** Compilation: javac
 * Accumulator.java Execution: java Accumulator < input.txt Dependencies: StdOut.java StdIn.java
 *
 * <p>Mutable data type that calculates the mean, sample standard deviation, and sample variance of
 * a stream of real numbers use a stable, one-pass algorithm.
 *
 * <p>****************************************************************************
 */
 ...
 *
 * <p>This implementation uses a one-pass algorithm that is less susceptible to floating-point
 * roundoff error than the more straightforward implementation based on saving the sum of the
 * squares of the numbers. This technique is due to <a href =
 * "https://en.wikipedia.org/wiki/Algorithms_for_calculating_variance#Online_algorithm">B. P.
 * Welford</a>. Each operation takes constant time in the worst case. The amount of memory is
 * constant - the data values are not stored.
 *
...
public class Accumulator {
  ...
  /**
   * Unit tests the {@code Accumulator} data type. Reads in a stream of real number from standard
   * input; adds them to the accumulator; and prints the mean, sample standard deviation, and sample
   * variance to standard output.
   *
