/**
 * **************************************************************************** Compilation: javac
 * NonrecursiveDirectedDFS.java Execution: java NonrecursiveDirectedDFS digraph.txt s Dependencies:
 * Digraph.java Queue.java Stack.java StdOut.java Data files:
 * https://algs4.cs.princeton.edu/42digraph/tinyDG.txt
 * https://algs4.cs.princeton.edu/42digraph/mediumDG.txt
 * https://algs4.cs.princeton.edu/42digraph/largeDG.txt
 *
 * <p>Run nonrecurisve depth-first search on an directed graph. Runs in O(E + V) time.
 *
 * <p>Explores the vertices in exactly the same order as DirectedDFS.java.
 *
 * <p>% java NonrecursiveDirectedDFS tinyDG.txt 1 1
 *
 * <p>% java NonrecursiveDirectedDFS tinyDG.txt 2 0 1 2 3 4 5
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code NonrecursiveDirectedDFS} class represents a data type for finding the vertices
 * reachable from a source vertex <em>s</em> in the digraph.
 *
 ...
 * is the number of vertices and <em>E</em> is the number of edges. Each instance method takes
 * &Theta;(1) time. It uses &Theta;(<em>V</em>) extra space (not including the digraph).
 *
...
public class NonrecursiveDirectedDFS {
   ...
   *
   * @param v the vertex
   * @return {@code true} if vertex {@code v} is reachable from the source vertex {@code s}, and
