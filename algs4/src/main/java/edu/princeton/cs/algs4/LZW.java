/**
 * **************************************************************************** Compilation: javac
 * LZW.java Execution: java LZW - < input.txt (compress) Execution: java LZW + < input.txt (expand)
 * Dependencies: BinaryIn.java BinaryOut.java Data files:
 * https://algs4.cs.princeton.edu/55compression/abraLZW.txt
 * https://algs4.cs.princeton.edu/55compression/ababLZW.txt
 *
 * <p>Compress or expand binary input from standard input using LZW.
 *
 * <p>WARNING: STARTING WITH ORACLE JAVA 6, UPDATE 7 the SUBSTRING METHOD TAKES TIME AND SPACE
 * LINEAR IN THE SIZE OF THE EXTRACTED SUBSTRING (INSTEAD OF CONSTANT SPACE AND TIME AS IN EARLIER
 * IMPLEMENTATIONS).
 *
 * <p>See <a href = "http://java-performance.info/changes-to-string-java-1-7-0_06/">this article</a>
 * for more details.
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code LZW} class provides static methods for compressing and expanding a binary input using
 * LZW compression over the 8-bit extended ASCII alphabet with 12-bit codewords.
 *
...
public class LZW {
   ...
   * 12-bit codewords; and writes the results to standard output.
   */
  ...
  /**
   * Reads a sequence of bit encoded using LZW compression with 12-bit codewords from standard
   * input; expands them; and writes the results to standard output.
   */
