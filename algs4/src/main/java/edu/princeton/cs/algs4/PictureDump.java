/**
 * **************************************************************************** Compilation: javac
 * PictureDump.java Execution: java PictureDump width height < file Dependencies: BinaryStdIn.java
 * Picture.java Data file: http://introcs.cs.princeton.edu/stdlib/abra.txt
 *
 * <p>Reads in a binary file and writes out the bits as w-by-h picture, with the 1 bits in black and
 * the 0 bits in white.
 *
 * <p>% more abra.txt ABRACADABRA!
 *
 * <p>% java PictureDump 16 6 < abra.txt
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code PictureDump} class provides a client for displaying the contents of a binary file as a
 ...
 *
 * <p>See also {@link BinaryDump} and {@link HexDump}.
 *
