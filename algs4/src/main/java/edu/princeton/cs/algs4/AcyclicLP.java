/**
 * **************************************************************************** Compilation: javac
 * AcyclicLP.java Execution: java AcyclicP V E Dependencies: EdgeWeightedDigraph.java
 * DirectedEdge.java Topological.java Data files: https://algs4.cs.princeton.edu/44sp/tinyEWDAG.txt
 *
 * <p>Computes longeset paths in an edge-weighted acyclic digraph.
 *
 * <p>Remark: should probably check that graph is a DAG before running
 *
 * <p>% java AcyclicLP tinyEWDAG.txt 5 5 to 0 (2.44) 5->1 0.32 1->3 0.29 3->6 0.52 6->4 0.93 4->0
 * 0.38 5 to 1 (0.32) 5->1 0.32 5 to 2 (2.77) 5->1 0.32 1->3 0.29 3->6 0.52 6->4 0.93 4->7 0.37 7->2
 * 0.34 5 to 3 (0.61) 5->1 0.32 1->3 0.29 5 to 4 (2.06) 5->1 0.32 1->3 0.29 3->6 0.52 6->4 0.93 5 to
 * 5 (0.00) 5 to 6 (1.13) 5->1 0.32 1->3 0.29 3->6 0.52 5 to 7 (2.43) 5->1 0.32 1->3 0.29 3->6 0.52
 * 6->4 0.93 4->7 0.37
 *
 * <p>****************************************************************************
 */
...
public class AcyclicLP {
  ...
  /**
   * Computes a longest paths tree from {@code s} to every other vertex in the directed acyclic
   * graph {@code G}.
   *
   ...
   *
   * @param v the destination vertex
   * @return a longest path from the source vertex {@code s} to vertex {@code v} as an iterable of
