/**
 * **************************************************************************** Compilation: javac
 * DirectedEulerianCycle.java Execution: java DirectedEulerianCycle V E Dependencies: Digraph.java
 * Stack.java StdOut.java BreadthFirstPaths.java DigraphGenerator.java StdRandom.java
 *
 * <p>Find an Eulerian cycle in a digraph, if one exists.
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code DirectedEulerianCycle} class represents a data type for finding an Eulerian cycle or
 * path in a digraph. An <em>Eulerian cycle</em> is a cycle (not necessarily simple) that uses every
 ...
 * &Theta;(<em>V</em>) extra space (not including the digraph).
 *
 * <p>To compute Eulerian paths in digraphs, see {@link DirectedEulerianPath}. To compute Eulerian
