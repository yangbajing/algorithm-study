/**
 * **************************************************************************** Compilation: javac
 * Topological.java Execution: java Topological filename.txt delimiter Dependencies: Digraph.java
 * DepthFirstOrder.java DirectedCycle.java EdgeWeightedDigraph.java EdgeWeightedDirectedCycle.java
 * SymbolDigraph.java Data files: https://algs4.cs.princeton.edu/42digraph/jobs.txt
 *
 * <p>Compute topological ordering of a DAG or edge-weighted DAG. Runs in O(E + V) time.
 *
 * <p>% java Topological jobs.txt "/" Calculus Linear Algebra Introduction to CS Advanced
 * Programming Algorithms Theoretical CS Artificial Intelligence Robotics Machine Learning Neural
 * Networks Databases Scientific Computing Computational Biology
 *
 * <p>****************************************************************************
 */
 ...
 *
 * <p>See {@link DirectedCycle}, {@link DirectedCycleX}, and {@link EdgeWeightedDirectedCycle} for
 * computing a directed cycle if the digraph is not a DAG. See {@link TopologicalX} for a
 * nonrecursive queue-based algorithm for computing a topological order of a DAG.
 *
...
public class Topological {
  ...
  /**
   * Determines whether the digraph {@code G} has a topological order and, if so, finds such a
   * topological order.
   *
   * @param G the digraph
   */
  ...
  /**
   * Returns a topological order if the digraph has a topologial order, and {@code null} otherwise.
   *
   * @return a topological order of the vertices (as an interable) if the digraph has a topological
   *     order (or equivalently, if the digraph is a DAG), and {@code null} otherwise
   */
   ...
   *
   * @return {@code true} if the digraph has a topological order (or equivalently, if the digraph is
   *     a DAG), and {@code false} otherwise
   */
   ...
   *
   * @param v the vertex
   * @return the position of vertex {@code v} in a topological order of the digraph; -1 if the
