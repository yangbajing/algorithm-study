/**
 * **************************************************************************** Compilation: javac
 * AmericanFlag.java Execution: java AmericanFlag < input.txt java AmericanFlag int <
 ...
 *
 * <p>% java AmericanFlag < shells.txt are by sea seashells seashells sells sells she she shells
...
/**
 * The {@code AmericanFlag} class provides static methods for sorting an array of extended ASCII
 * strings or integers in-place using American flag sort. This is a non-recursive implementation.
 *
 ...
 * Sort</a> by McIlroy and Bostic. For a version that uses only one auxilary array, see {@link
 * AmericanFlagX}.
 *
