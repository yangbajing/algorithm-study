/**
 * **************************************************************************** Compilation: javac
 * DirectedCycle.java Execution: java DirectedCycle input.txt Dependencies: Digraph.java Stack.java
 * StdOut.java In.java Data files: https://algs4.cs.princeton.edu/42digraph/tinyDG.txt
 * https://algs4.cs.princeton.edu/42digraph/tinyDAG.txt
 *
 * <p>Finds a directed cycle in a digraph.
 *
 * <p>% java DirectedCycle tinyDG.txt Directed cycle: 3 5 4 3
 *
 * <p>% java DirectedCycle tinyDAG.txt No directed cycle
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code DirectedCycle} class represents a data type for determining whether a digraph has a
 ...
 *
 * <p>See {@link Topological} to compute a topological order if the digraph is acyclic.
 *
...
public class DirectedCycle {
  ...
  public DirectedCycle(Digraph G) {
    ...
    edgeTo = new int[G.V()];
    for (int v = 0; v < G.V(); v++) if (!marked[v] && cycle == null) dfs(G, v);
  }
