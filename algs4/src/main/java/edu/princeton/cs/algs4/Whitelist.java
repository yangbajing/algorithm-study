/**
 * **************************************************************************** Compilation: javac
 * Whitelist.java Execution: java Whitelist whitelist.txt < data.txt Dependencies:
 * StaticSetOfInts.java In.java StdOut.java
 *
 * <p>Data files: https://algs4.cs.princeton.edu/11model/tinyW.txt
 ...
 * <p>Whitelist filter.
 *
 * <p>% java Whitelist tinyW.txt < tinyT.txt 50 99 13
 *
 * <p>% java Whitelist largeW.txt < largeT.txt | more 499569 984875 295754 207807 140925 161828
...
/**
 * The {@code Whitelist} class provides a client for reading in a set of integers from a file;
 * reading in a sequence of integers from standard input; and printing to standard output those
...
public class Whitelist {
   ...
   * Reads in integers from standard input and prints to standard output those integers that are not
   * in the file.
   *
