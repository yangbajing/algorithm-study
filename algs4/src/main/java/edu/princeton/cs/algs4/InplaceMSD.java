/**
 * **************************************************************************** Compilation: javac
 * InplaceMSD.java Execution: java InplaceMSD < input.txt Dependencies: StdIn.java StdOut.java Data
 * files: https://algs4.cs.princeton.edu/51radix/words3.txt
 * https://algs4.cs.princeton.edu/51radix/shells.txt
 *
 * <p>Sort an array of strings or integers using in-place MSD radix sort.
 *
 * <p>% java InplaceMSD < shells.txt are by sea seashells seashells sells sells she she shells shore
 * surely the the
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code InplaceMSD} class provides static methods for sorting an array of extended ASCII
 * strings using in-place MSD radix sort.
 *
...
public class InplaceMSD {
  ...
  /**
   * Rearranges the array of extended ASCII strings in ascending order. This is an unstable sorting
   * algorithm.
   *
  ...
  private static void sort(String[] a, int lo, int hi, int d) {
    ...
    for (int r = 0; r < R; r++) sort(a, tails[r], tails[r + 1] - 1, d + 1);
  }
  ...
  /**
   * Reads in a sequence of extended ASCII strings from standard input; in-place MSD radix sorts
