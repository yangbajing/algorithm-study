/**
 * **************************************************************************** Compilation: javac
 * ThreeSum.java Execution: java ThreeSum input.txt Dependencies: In.java StdOut.java Stopwatch.java
 ...
 *
 * <p>A program with cubic running time. Reads n integers and counts the number of triples that sum
 * to exactly 0 (ignoring integer overflow).
 *
 * <p>% java ThreeSum 1Kints.txt 70
 *
 * <p>% java ThreeSum 2Kints.txt 528
 *
 * <p>% java ThreeSum 4Kints.txt 4039
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code ThreeSum} class provides static methods for counting and printing the number of
 * triples in an array of integers that sum to 0 (ignoring integer overflow).
 *
 * <p>This implementation uses a triply nested loop and takes proportional to n^3, where n is the
 * number of integers.
 *
