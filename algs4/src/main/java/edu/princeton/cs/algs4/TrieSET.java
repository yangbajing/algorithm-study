/**
 * **************************************************************************** Compilation: javac
 * TrieSET.java Execution: java TrieSET < words.txt Dependencies: StdIn.java Data files:
 * https://algs4.cs.princeton.edu/52trie/shellsST.txt
 *
 * <p>An set for extended ASCII strings, implemented using a 256-way trie.
 *
 * <p>Sample client reads in a list of words from standard input and prints out each word, removing
 * any duplicates.
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code TrieSET} class represents an ordered set of strings over the extended ASCII alphabet.
 ...
 *
 * <p>This implementation uses a 256-way trie. The <em>add</em>, <em>contains</em>, <em>delete</em>,
 * and <em>longest prefix</em> methods take time proportional to the length of the key (in the worst
 * case). Construction takes constant time.
 *
 * <p>For additional documentation, see <a href="https://algs4.cs.princeton.edu/52trie">Section
 * 5.2</a> of <i>Algorithms in Java, 4th Edition</i> by Robert Sedgewick and Kevin Wayne.
 *
...
public class TrieSET implements Iterable<String> {
  ...
  /**
   * Returns the string in the set that is the longest prefix of {@code query}, or {@code null}, if
   * no such string.
   *
  ...
  public static void main(String[] args) {
    ...
    for (String s : set.keysWithPrefix("shor")) StdOut.println(s);
    StdOut.println();

    StdOut.println("keysWithPrefix(\"shortening\"):");
    for (String s : set.keysWithPrefix("shortening")) StdOut.println(s);
    StdOut.println();

    StdOut.println("keysThatMatch(\".he.l.\"):");
    for (String s : set.keysThatMatch(".he.l.")) StdOut.println(s);
  }
}
