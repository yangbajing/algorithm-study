/**
 * **************************************************************************** Compilation: javac
 * Digraph.java Execution: java Digraph filename.txt Dependencies: Bag.java In.java StdOut.java Data
 * files: https://algs4.cs.princeton.edu/42digraph/tinyDG.txt
 * https://algs4.cs.princeton.edu/42digraph/mediumDG.txt
 * https://algs4.cs.princeton.edu/42digraph/largeDG.txt
 *
 * <p>A graph, implemented using an array of lists. Parallel edges and self-loops are permitted.
 *
 * <p>% java Digraph tinyDG.txt 13 vertices, 22 edges 0: 5 1 1: 2: 0 3 3: 5 2 4: 3 2 5: 4 6: 9 4 8 0
 * 7: 6 9 8: 6 9: 11 10 10: 12 11: 4 12 12: 9
 *
 * <p>****************************************************************************
 */
 ...
 * It supports the following two primary operations: add an edge to the digraph, iterate over all of
 * the vertices adjacent from a given vertex. It also provides methods for returning the indegree or
 * outdegree of a vertex, the number of vertices <em>V</em> in the digraph, the number of edges
 * <em>E</em> in the digraph, and the reverse digraph. Parallel edges and self-loops are permitted.
 *
 ...
 * proportional to the outdegree of the vertex.) Constructing an empty digraph with <em>V</em>
 * vertices takes &Theta;(<em>V</em>) time; constructing a digraph with <em>E</em> edges and
