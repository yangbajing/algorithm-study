/**
 * **************************************************************************** Compilation: javac
 * IndexMinPQ.java Execution: java IndexMinPQ Dependencies: StdOut.java
 *
 * <p>Minimum-oriented indexed PQ implementation using a binary heap.
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code IndexMinPQ} class represents an indexed priority queue of generic keys. It supports
 * the usual <em>insert</em> and <em>delete-the-minimum</em> operations, along with <em>delete</em>
 * and <em>change-the-key</em> methods. In order to let the client refer to keys on the priority
 ...
 * at the minimum key, testing if the priority queue is empty, and iterating through the keys.
 *
