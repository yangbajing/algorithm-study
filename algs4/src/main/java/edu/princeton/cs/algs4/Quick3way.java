/**
 * **************************************************************************** Compilation: javac
 * Quick3way.java Execution: java Quick3way < input.txt Dependencies: StdOut.java StdIn.java Data
 * files: https://algs4.cs.princeton.edu/23quicksort/tiny.txt
 * https://algs4.cs.princeton.edu/23quicksort/words3.txt
 *
 * <p>Sorts a sequence of strings from standard input using 3-way quicksort.
 *
 * <p>% more tiny.txt S O R T E X A M P L E
 *
 * <p>% java Quick3way < tiny.txt A E E L M O P R S T X [ one string per line ]
 *
 * <p>% more words3.txt bed bug dad yes zoo ... all bad yet
 *
 * <p>% java Quick3way < words3.txt all bad bed bug dad ... yes yet zoo [ one string per line ]
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code Quick3way} class provides static methods for sorting an array using quicksort with
 * 3-way partitioning.
 *
...
public class Quick3way {
  ...
  /**
   * Reads in a sequence of strings from standard input; 3-way quicksorts them; and prints them to
