/**
 * **************************************************************************** Compilation: javac
 * LSD.java Execution: java LSD < input.txt Dependencies: StdIn.java StdOut.java Data files:
 * https://algs4.cs.princeton.edu/51radix/words3.txt
 *
 * <p>LSD radix sort
 *
 * <p>- Sort a String[] array of n extended ASCII strings (R = 256), each of length w.
 *
 * <p>- Sort an int[] array of n 32-bit integers, treating each integer as a sequence of w = 4 bytes
 * (R = 256).
 *
 * <p>Uses extra space proportional to n + R.
 *
 * <p>% java LSD < words3.txt all bad bed bug dad ... yes yet zoo
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code LSD} class provides static methods for sorting an array of <em>w</em>-character
 * strings or 32-bit integers using LSD radix sort.
 *
...
public class LSD {
  ...
  /**
   * Reads in a sequence of fixed-length strings from standard input; LSD radix sorts them; and
