/**
 * **************************************************************************** Compilation: javac
 * Point2D.java Execution: java Point2D x0 y0 n Dependencies: StdDraw.java StdRandom.java
 *
 * <p>Immutable point data type for points in the plane.
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code Point} class is an immutable data type to encapsulate a two-dimensional point with
 * real-value coordinates.
 *
 * <p>Note: in order to deal with the difference behavior of double and Double with respect to -0.0
 * and +0.0, the Point2D constructor converts any coordinates that are -0.0 to +0.0.
 *
...
public final class Point2D implements Comparable<Point2D> {
   ...
   * @throws IllegalArgumentException if either {@code x} or {@code y} is {@code Double.NaN}, {@code
   *     Double.POSITIVE_INFINITY} or {@code Double.NEGATIVE_INFINITY}
   */
   ...
   * point (x0, y0) is less than the argument point (x1, y1) if and only if either {@code y0 < y1}
   * or if {@code y0 == y1} and {@code x0 < x1}.
   *
   * @param that the other point
   * @return the value {@code 0} if this string is equal to the argument string (precisely when
   *     {@code equals()} returns {@code true}); a negative integer if this point is less than the
