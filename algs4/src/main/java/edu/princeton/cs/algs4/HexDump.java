/**
 * **************************************************************************** Compilation: javac
 * HexDump.java Execution: java HexDump < file Dependencies: BinaryStdIn.java StdOut.java Data file:
 * https://algs4.cs.princeton.edu/55compression/abra.txt
 *
 * <p>Reads in a binary file and writes out the bytes in hex, 16 per line.
 *
 * <p>% more abra.txt ABRACADABRA!
 *
 * <p>% java HexDump 16 < abra.txt 41 42 52 41 43 41 44 41 42 52 41 21 96 bits
 *
 * <p>Remark -------------------------- - Similar to the Unix utilities od (octal dump) or hexdump
 * (hexadecimal dump).
 *
 * <p>% od -t x1 < abra.txt 0000000 41 42 52 41 43 41 44 41 42 52 41 21 0000014
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code HexDump} class provides a client for displaying the contents of a binary file in
 * hexadecimal.
 *
 ...
 *
 * <p>See also {@link BinaryDump} and {@link PictureDump}. For more full-featured versions, see the
 * Unix utilities {@code od} (octal dump) and {@code hexdump} (hexadecimal dump).
 *
 * <p>
 *
