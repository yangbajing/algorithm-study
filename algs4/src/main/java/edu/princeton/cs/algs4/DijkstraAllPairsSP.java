/**
 * **************************************************************************** Compilation: javac
 * DijkstraAllPairsSP.java Execution: none Dependencies: EdgeWeightedDigraph.java Dijkstra.java
 *
 * <p>Dijkstra's algorithm run from each vertex. Takes time proportional to E V log V and space
 * proportional to EV.
 *
 * <p>% java DijkstraAllPairsSP tinyEWD.txt
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code DijkstraAllPairsSP} class represents a data type for solving the all-pairs shortest
 * paths problem in edge-weighted digraphs where the edge weights are nonnegative.
 *
 * <p>This implementation runs Dijkstra's algorithm from each vertex. The constructor takes
 * &Theta;(<em>V</em> (<em>E</em> log <em>V</em>)) time in the worst case, where <em>V</em> is the
 * number of vertices and <em>E</em> is the number of edges. Each instance method takes &Theta;(1)
 * time. It uses &Theta;(<em>V</em><sup>2</sup>) extra space (not including the edge-weighted
 * digraph).
 *
