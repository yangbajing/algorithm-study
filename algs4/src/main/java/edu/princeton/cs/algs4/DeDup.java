/**
 * **************************************************************************** Compilation: javac
 * DeDup.java Execution: java DeDup < input.txt Dependencies: SET StdIn.java StdOut.java Data files:
 * https://algs4.cs.princeton.edu/35applications/tinyTale.txt
 *
 * <p>Read in a list of words from standard input and print out each word, removing any duplicates.
 *
 ...
 * winter of despair
 *
 * <p>% java DeDup < tinyTale.txt it was the best of times worst age wisdom ... winter despair
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code DeDup} class provides a client for reading in a sequence of words from standard input
 * and printing each word, removing any duplicates. It is useful as a test client for various symbol
