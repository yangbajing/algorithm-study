/**
 * **************************************************************************** Compilation: javac
 * Insertion.java Execution: java Insertion < input.txt Dependencies: StdOut.java StdIn.java Data
 * files: https://algs4.cs.princeton.edu/21elementary/tiny.txt
 * https://algs4.cs.princeton.edu/21elementary/words3.txt
 *
 * <p>Sorts a sequence of strings from standard input using insertion sort.
 *
 * <p>% more tiny.txt S O R T E X A M P L E
 *
 * <p>% java Insertion < tiny.txt A E E L M O P R S T X [ one string per line ]
 *
 * <p>% more words3.txt bed bug dad yes zoo ... all bad yet
 *
 * <p>% java Insertion < words3.txt all bad bed bug dad ... yes yet zoo [ one string per line ]
 *
 * <p>****************************************************************************
 */
 ...
 *
 * <p>In the worst case, this implementation makes ~ &frac12; <em>n</em><sup>2</sup> compares and ~
 * &frac12; <em>n</em><sup>2</sup> exchanges to sort an array of length <em>n</em>. So, it is not
 ...
 *
 * <p>See <a
 * href="https://algs4.cs.princeton.edu/21elementary/InsertionPedantic.java.html">InsertionPedantic.java</a>
...
public class Insertion {
  ...
  public static int[] indexSort(Comparable[] a) {
    ...
    for (int i = 1; i < n; i++)
      for (int j = i; j > 0 && less(a[index[j]], a[index[j - 1]]); j--) exch(index, j, j - 1);
