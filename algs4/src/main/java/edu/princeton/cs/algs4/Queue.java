/**
 * **************************************************************************** Compilation: javac
 * Queue.java Execution: java Queue < input.txt Dependencies: StdIn.java StdOut.java Data files:
 * https://algs4.cs.princeton.edu/13stacks/tobe.txt
 *
 * <p>A generic queue, implemented using a linked list.
 *
...
/**
 * The {@code Queue} class represents a first-in-first-out (FIFO) queue of generic items. It
 ...
 * nodes. See {@link LinkedQueue} for the version from the textbook that uses a non-static nested
 * class. See {@link ResizingArrayQueue} for a version that uses a resizing array. The
 * <em>enqueue</em>, <em>dequeue</em>, <em>peek</em>, <em>size</em>, and <em>is-empty</em>
