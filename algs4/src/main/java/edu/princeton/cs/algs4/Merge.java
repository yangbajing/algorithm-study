...
/**
 * The {@code Merge} class provides static methods for sorting an array using a top-down, recursive
 * version of <em>mergesort</em>.
 *
 * <p>This implementation takes &Theta;(<em>n</em> log <em>n</em>) time to sort any array of length
 * <em>n</em> (assuming comparisons take constant time). It makes between ~ &frac12; <em>n</em>
 * log<sub>2</sub> <em>n</em> and ~ 1 <em>n</em> log<sub>2</sub> <em>n</em> compares.
 *
 * <p>This sorting algorithm is stable. It uses &Theta;(<em>n</em>) extra memory (not including the
 * input array).
 *
