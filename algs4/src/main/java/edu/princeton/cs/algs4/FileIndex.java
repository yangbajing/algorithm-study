/**
 * **************************************************************************** Compilation: javac
 * FileIndex.java Execution: java FileIndex file1.txt file2.txt file3.txt ... Dependencies: ST.java
 * SET.java In.java StdIn.java StdOut.java Data files:
 ...
 *
 * <p>% java FileIndex ex*.txt age ex3.txt ex4.txt best ex1.txt was ex1.txt ex2.txt ex3.txt ex4.txt
 *
 * <p>% java FileIndex *.txt
 *
 * <p>% java FileIndex *.java
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code FileIndex} class provides a client for indexing a set of files, specified as
 * command-line arguments. It takes queries from standard input and prints each file that contains
 * the given query.
 *
