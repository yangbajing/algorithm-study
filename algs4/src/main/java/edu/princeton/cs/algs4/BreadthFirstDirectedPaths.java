/**
 * **************************************************************************** Compilation: javac
 * BreadthFirstDirectedPaths.java Execution: java BreadthFirstDirectedPaths digraph.txt s
 * Dependencies: Digraph.java Queue.java Stack.java Data files:
 * https://algs4.cs.princeton.edu/42digraph/tinyDG.txt
 * https://algs4.cs.princeton.edu/42digraph/mediumDG.txt
 * https://algs4.cs.princeton.edu/42digraph/largeDG.txt
 *
 * <p>Run breadth-first search on a digraph. Runs in O(E + V) time.
 *
 * <p>% java BreadthFirstDirectedPaths tinyDG.txt 3 3 to 0 (2): 3->2->0 3 to 1 (3): 3->2->0->1 3 to
 * 2 (1): 3->2 3 to 3 (0): 3 3 to 4 (2): 3->5->4 3 to 5 (1): 3->5 3 to 6 (-): not connected 3 to 7
 * (-): not connected 3 to 8 (-): not connected 3 to 9 (-): not connected 3 to 10 (-): not connected
 * 3 to 11 (-): not connected 3 to 12 (-): not connected
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code BreadthDirectedFirstPaths} class represents a data type for finding shortest paths
...
public class BreadthFirstDirectedPaths {
  ...
  /**
   * Computes the shortest path from any one of the source vertices in {@code sources} to every
  ...
  /**
   * Returns the number of edges in a shortest path from the source {@code s} (or sources) to vertex
   * {@code v}?
   *
   * @param v the vertex
  ...
  /**
   * Returns a shortest path from {@code s} (or sources) to {@code v}, or {@code null} if no such
   * path.
   *
   * @param v the vertex
