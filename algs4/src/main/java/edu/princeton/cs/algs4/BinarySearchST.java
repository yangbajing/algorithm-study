/**
 * **************************************************************************** Compilation: javac
 * BinarySearchST.java Execution: java BinarySearchST Dependencies: StdIn.java StdOut.java Data
 * files: https://algs4.cs.princeton.edu/31elementary/tinyST.txt
 *
 * <p>Symbol table implementation with binary search in an ordered array.
 *
 * <p>% more tinyST.txt S E A R C H E X A M P L E
 *
 * <p>% java BinarySearchST < tinyST.txt A 8 C 4 E 12 H 5 L 11 M 9 P 10 R 3 S 0 X 7
 *
 * <p>****************************************************************************
 */
 ...
 * <em>maximum</em>, <em>floor</em>, <em>select</em>, and <em>ceiling</em>. It also provides a
 ...
 * table.
 *
 * <p>This implementation uses a sorted array. It requires that the key type implements the {@code
 * Comparable} interface and calls the {@code compareTo()} and method to compare two keys. It does
 * not call either {@code equals()} or {@code hashCode()}. The <em>put</em> and <em>remove</em>
 * operations each take linear time in the worst case; the <em>contains</em>, <em>ceiling</em>,
 * <em>floor</em>, and <em>rank</em> operations take logarithmic time; the <em>size</em>,
 * <em>is-empty</em>, <em>minimum</em>, <em>maximum</em>, and <em>select</em> operations take
 ...
 * Edition</i> by Robert Sedgewick and Kevin Wayne. For other implementations, see {@link ST},
 * {@link BST}, {@link SequentialSearchST}, {@link RedBlackBST}, {@link SeparateChainingHashST}, and
 * {@link LinearProbingHashST}, <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne.
 */
public class BinarySearchST<Key extends Comparable<Key>, Value> {
  ...
  /**
   * Removes the specified key and associated value from this symbol table (if the key is in the
   * symbol table).
   *
   * @param key the key
   * @throws IllegalArgumentException if {@code key} is {@code null}
   ...
   * @return the number of keys in this symbol table between {@code lo} (inclusive) and {@code hi}
   *     (inclusive)
