/**
 * **************************************************************************** Compilation: javac
 * ResizingArrayBag.java Execution: java ResizingArrayBag Dependencies: StdIn.java StdOut.java
 *
 * <p>Bag implementation with a resizing array.
 *
 * <p>****************************************************************************
 */
 ...
 *
 * <p>This implementation uses a resizing array. See {@link LinkedBag} for a version that uses a
 * singly linked list. The <em>add</em> operation takes constant amortized time; the
