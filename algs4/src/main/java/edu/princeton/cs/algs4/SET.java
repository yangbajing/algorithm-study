...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
  ...
  /**
   * Removes the specified key from this set (if the set contains the specified key). This is
   * equivalent to {@code remove()}, but we plan to deprecate {@code delete()}.
   *
   * @param key the key
   * @throws IllegalArgumentException if {@code key} is {@code null}
   */
  ...
  /**
   * Removes the specified key from this set (if the set contains the specified key). This is
   * equivalent to {@code delete()}, but we plan to deprecate {@code delete()}.
   *
   * @param key the key
   * @throws IllegalArgumentException if {@code key} is {@code null}
   */
