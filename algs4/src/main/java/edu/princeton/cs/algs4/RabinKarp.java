/**
 * **************************************************************************** Compilation: javac
 * RabinKarp.java Execution: java RabinKarp pat txt Dependencies: StdOut.java
 *
 * <p>Reads in two strings, the pattern and the input text, and searches for the pattern in the
 * input text using the Las Vegas version of the Rabin-Karp algorithm.
 *
 * <p>% java RabinKarp abracadabra abacadabrabracabracadabrabrabracad pattern: abracadabra text:
 * abacadabrabracabracadabrabrabracad match: abracadabra
 *
 * <p>% java RabinKarp rab abacadabrabracabracadabrabrabracad pattern: rab text:
 * abacadabrabracabracadabrabrabracad match: rab
 *
 * <p>% java RabinKarp bcara abacadabrabracabracadabrabrabracad pattern: bcara text:
 * abacadabrabracabracadabrabrabracad
 *
 * <p>% java RabinKarp rabrabracad abacadabrabracabracadabrabrabracad text:
 * abacadabrabracabracadabrabrabracad pattern: rabrabracad
 *
 * <p>% java RabinKarp abacad abacadabrabracabracadabrabrabracad text:
 ...
 *
 * <p>This implementation uses the Rabin-Karp algorithm.
 *
