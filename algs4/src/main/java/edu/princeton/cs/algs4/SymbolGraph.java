/**
 * **************************************************************************** Compilation: javac
 * SymbolGraph.java Execution: java SymbolGraph filename.txt delimiter Dependencies: ST.java
 * Graph.java In.java StdIn.java StdOut.java Data files:
 ...
 *
 * <p>% java SymbolGraph routes.txt " " JFK MCO ATL ORD LAX PHX LAS
 *
 * <p>% java SymbolGraph movies.txt "/" Tin Men (1987) Hershey, Barbara Geppi, Cindy Jones, Kathy
 * (II) Herr, Marcia ... Blumenfeld, Alan DeBoy, David Bacon, Kevin Woodsman, The (2004) Wild Things
 * (1998) Where the Truth Lies (2005) Tremors (1990) ... Apollo 13 (1995) Animal House (1978)
 *
 * <p>Assumes that input file is encoded using UTF-8. % iconv -f ISO-8859-1 -t UTF-8
 * movies-iso8859.txt > movies.txt
 *
 * <p>****************************************************************************
 */
...
public class SymbolGraph {
  ...
  /**
   * Returns the graph assoicated with the symbol graph. It is the client's responsibility not to
   * mutate the graph.
   *
