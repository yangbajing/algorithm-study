/**
 * **************************************************************************** Compilation: javac
 * Interval1D.java Execution: java Interval1D Dependencies: StdOut.java
 *
 * <p>1-dimensional interval data type.
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code Interval1D} class represents a one-dimensional interval. The interval is
 * <em>closed</em>—it contains both endpoints. Intervals are immutable: their values cannot be
 * changed after they are created. The class {@code Interval1D} includes methods for checking
 * whether an interval contains a point and determining whether two intervals intersect.
 *
