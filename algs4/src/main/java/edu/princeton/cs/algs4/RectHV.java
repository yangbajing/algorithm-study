/**
 * **************************************************************************** Compilation: javac
 * RectHV.java Execution: none Dependencies: Point2D.java
 *
 * <p>Immutable data type for 2D axis-aligned rectangle.
 *
 * <p>****************************************************************************
 */
...
public final class RectHV {
   ...
   * @throws IllegalArgumentException if any of {@code xmin}, {@code xmax}, {@code ymin}, or {@code
   *     ymax} is {@code Double.NaN}.
  ...
  /**
   * Returns true if the two rectangles intersect. This includes <em>improper intersections</em> (at
   * points on the boundary of each rectangle) and <em>nested intersctions</em> (when one rectangle
   ...
   *
   * @param p the point
   * @return {@code true} if this rectangle contain the point {@code p}, possibly at the boundary;
   ...
   *
   * @param p the point
   * @return the Euclidean distance between the point {@code p} and the closest point on this
   *     rectangle; 0 if the point is contained in this rectangle
   */
   ...
   *
   * @param p the point
   * @return the square of the Euclidean distance between the point {@code p} and the closest point
   ...
   *
   * @return a string representation of this rectangle, using the format {@code [xmin, xmax] x
   *     [ymin, ymax]}
   */
  @Override
