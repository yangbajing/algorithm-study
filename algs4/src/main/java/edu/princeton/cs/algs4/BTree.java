/**
 * **************************************************************************** Compilation: javac
 * BTree.java Execution: java BTree Dependencies: StdOut.java
 *
 * <p>B-tree.
 *
 * <p>Limitations ----------- - Assumes M is even and M >= 4 - should b be an array of children or
 * list (it would help with casting to make it a list)
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code BTree} class represents an ordered symbol table of generic key-value pairs. It
 * supports the <em>put</em>, <em>get</em>, <em>contains</em>, <em>size</em>, and <em>is-empty</em>
 * methods. A symbol table implements the <em>associative array</em> abstraction: when associating a
 ...
 *
 * <p>This implementation uses a B-tree. It requires that the key type implements the {@code
 * Comparable} interface and calls the {@code compareTo()} and method to compare two keys. It does
 * not call either {@code equals()} or {@code hashCode()}. The <em>get</em>, <em>put</em>, and
 * <em>contains</em> operations each make log<sub><em>m</em></sub>(<em>n</em>) probes in the worst
 * case, where <em>n</em> is the number of key-value pairs and <em>m</em> is the branching factor.
 * The <em>size</em>, and <em>is-empty</em> operations take constant time. Construction takes
 * constant time.
 *
 * <p>For additional documentation, see <a href="https://algs4.cs.princeton.edu/62btree">Section
 * 6.2</a> of <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne.
 */
