/**
 * **************************************************************************** Compilation: javac
 * DepthFirstSearch.java Execution: java DepthFirstSearch filename.txt s Dependencies: Graph.java
 * StdOut.java Data files: https://algs4.cs.princeton.edu/41graph/tinyG.txt
 * https://algs4.cs.princeton.edu/41graph/mediumG.txt
 *
 * <p>Run depth first search on an undirected graph. Runs in O(E + V) time.
 *
 * <p>% java DepthFirstSearch tinyG.txt 0 0 1 2 3 4 5 6 NOT connected
 *
 * <p>% java DepthFirstSearch tinyG.txt 9 9 10 11 12 NOT connected
 *
 * <p>****************************************************************************
 */
...
/**
 * The {@code DepthFirstSearch} class represents a data type for determining the vertices connected
 * to a given source vertex <em>s</em> in an undirected graph. For versions that find the paths, see
 * {@link DepthFirstPaths} and {@link BreadthFirstPaths}.
 *
 * <p>This implementation uses depth-first search. See {@link NonrecursiveDFS} for a non-recursive
 * version. The constructor takes &Theta;(<em>V</em> + <em>E</em>) time in the worst case, where
 * <em>V</em> is the number of vertices and <em>E</em> is the number of edges. Each instance method
 * takes &Theta;(1) time. It uses &Theta;(<em>V</em>) extra space (not including the graph).
 *
